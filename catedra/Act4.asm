...
direccion db "C:\EMU8086\MyBuild\practica07", 0 ;direccion del directorio
direccion2 db "C:\EMU8086\MyBuild", 0         ;direccion del directorio padre
dirAux db "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$", 0
dirAux2 db "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$", 0 
archivo db "C:\EMU8086\MyBuild\practica07\munoz.txt", 0 ;direccion del archivo

mensaje db "Traductores de lenguaje I"        ;cadena de caracteres que se escribira en el archivo
